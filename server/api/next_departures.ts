    ...
    for (const s of (idfm_resp as any).Siri.ServiceDelivery.StopMonitoringDelivery.flatMap(
      ...
      if (
        ...
        stop.next_departures.push({
          ...
          stop_point_name:
            s?.MonitoredVehicleJourney?.MonitoredCall?.StopPointName?.[0]
              ?.value,
          vehicule_at_stop:
            s?.MonitoredVehicleJourney?.MonitoredCall?.VehicleAtStop,
          destination_display:
            s?.MonitoredVehicleJourney?.MonitoredCall?.DestinationDisplay?.[0]
              ?.value,
          expected_arrival_time:
            s?.MonitoredVehicleJourney?.MonitoredCall?.ExpectedArrivalTime,
          aimed_arrival_time:
            s?.MonitoredVehicleJourney?.MonitoredCall?.AimedArrivalTime,
          expected_departure_time:
            s?.MonitoredVehicleJourney?.MonitoredCall?.ExpectedDepartureTime,
          aimed_departure_time:
            s?.MonitoredVehicleJourney?.MonitoredCall?.AimedDepartureTime,
          arrival_platform_name:
            s?.MonitoredVehicleJourney?.MonitoredCall?.ArrivalPlatformName
              ?.value,
          departure_status:
            s?.MonitoredVehicleJourney?.MonitoredCall?.DepartureStatus,
          arrival_status:
            s?.MonitoredVehicleJourney?.MonitoredCall?.ArrivalStatus,
        });
      }
    }
  }
